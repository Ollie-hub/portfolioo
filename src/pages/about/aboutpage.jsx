    ...
    <article className="about-section">
        <h3>About Me</h3> <section>  
            <div className="about-content" id="about-nav">
                ...
                <br/><br/>What did i do in New York? To be honest, not really anything. 
                I relaxed living with my parents. And studied some courses on the internet. What's my future goal? I want to work in Web/Software development. Where that might be i don't know yet. 
                <br/>
                <br/>
                <br/>
